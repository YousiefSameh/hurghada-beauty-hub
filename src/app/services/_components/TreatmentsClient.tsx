  ...
  return (
    <>
      <main className="min-h-screen bg-[#FAF7F2] text-stone-900 selection:bg-[#A05C3C] selection:text-white pb-24">
        {/* Hero Section */}
        <section className="relative h-[60vh] min-h-125 w-full flex items-center">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'Hurghada Beauty Hub',
            url: 'https://hurghadabeautyhub.com/services',
            availableService: [
              {
                '@type': 'MedicalProcedure',
                name: 'Botox & Dermal Fillers Injections',
              },
              {
                '@type': 'MedicalProcedure',
                name: 'HydraFacial & Deep Skin Cleansing',
              },
              {
                '@type': 'MedicalProcedure',
                name: 'Hair & Face PRP Plasma Therapy',
              },
              {
                '@type': 'MedicalProcedure',
                name: 'Skin Rejuvenation & Anti-Aging Protocols',
              },
            ],
          }),
        }}
